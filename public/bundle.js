...
store.dispatch((0, _actions.turnOff)('iddqd'));
console.log(store.getState());
console.log(store.getState());

_reactDom2.default.render(_react2.default.createElement(DevicesContainer, { devices: devices }), document.querySelector('#root'));
...
var _deviceReducer = __webpack_require__(70);

var _deviceReducer2 = _interopRequireDefault(_deviceReducer);
...
var reducers = (0, _redux.combineReducers)({
    devices: _deviceReducer2.default
});
...
var _defaultState = __webpack_require__(71);

var _defaultState2 = _interopRequireDefault(_defaultState);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var tvReducer = function tvReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _defaultState2.default.devices.tv;
    var action = arguments[1];

    switch (action.type) {
        case 'TURN_ON':
            return Object.assign({}, state, {
                items: state.items.map(function (tv) {
                    if (tv.id === action.id) {
...
var turnOn = exports.turnOn = function turnOn(item) {
    return {
        type: 'TURN_ON',
        id: item.id
    };
...
var turnOff = exports.turnOff = function turnOff(item) {
    return {
        type: 'TURN_OFF',
        id: item.id
    };
...
var addDevice = exports.addDevice = function addDevice(item) {
    return {
        type: 'ADD_DEVICE',
        payload: {
            id: item.id,
